...
& $sqlComparePath /server1:"localhost" /db1:"Confluence" /empty2 /sf:"$objectsPath"

#create lookup data
$sqlDataComparePath = "C:\Program Files (x86)\Red Gate\SQL Data Compare 14\SQLDataCompare.exe"
& $sqlDataComparePath /server1:"localhost" /db1:"Confluence" /empty2 /sf:"$lookupsPath" /Include:table:tbl_lk_.*