...
GO
ALTER TABLE [dbo].[tbl_lk_Confluence_Refresh_Status] ADD CONSTRAINT [PK_tbl_lk_Confluence_Refresh_Status] PRIMARY KEY CLUSTERED  ([Refresh_Status_Code]) ON [PRIMARY]
GO
